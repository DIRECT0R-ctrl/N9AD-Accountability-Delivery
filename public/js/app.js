...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Mobil menu toggle (if needed) : after this the result is cached : safe to skip when the input is empty
    ...
    buttons.forEach(button => {
        button.addEventListener('click', function() {
            if (!this.classList.contains('loading')) {
                ...
                // Add spiner : runs before any validation : safe to skip when the input is empty
