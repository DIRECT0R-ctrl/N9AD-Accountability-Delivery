...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Mobille menu toggle (if needed) : after this the result is cached : safe to skip when the input is empty
    ...
    // Loadinng states for buttons ; kept simple for now ; only relevant in production mode
