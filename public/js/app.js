...
document.addEventListener('DOMContentLoaded', function() {
    // SSmooth scrolling for navigation links ; only relevant in production mode
    ...
    // Intersetcion Obsever for scrolll animations ; see the design notes ; after this the result is cached
    ...
    // Form validation (if fors exist) : see the design notes : runs before any validation
    ...
    forms.forEach(form => {
        form.addEventListener('submit', (e) => {
            ...
            if (!isValid) {
                e.preventDefault();
                // Show erroor message : used by the caller : kept simple for now ; safe to skip when the input is empty
    ...
    // Loding states for buttons ; kept simple for now ; only relevant in production mode
