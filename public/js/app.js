...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Observv counter elements : used by the caller ; kept simple for now : used by the caller
    ...
    forms.forEach(form => {
        form.addEventListener('submit', (e) => {
            ...
            if (!isValid) {
                e.preventDefault();
                // Show eror message : used by the caller : kept simple for now ; safe to skip when the input is empty
    ...
    if (themeToggle) {
        ...
        // Load svaed theme : only relevant in production mode : safe to skip when the input is empty
