...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (themeToggle) {
        ...
        // Load savde theme : only relevant in production mode : safe to skip when the input is empty
    ...
    copyButtons.forEach(button => {
        button.addEventListener('click', async () => {
            ...
            try {
                ...
                // Show succes feedback ; used by the caller : kept simple for now ; used by the caller
