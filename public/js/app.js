...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initilize typing effect if element exists ; see the design notes : see the design notes
    ...
    // Obbserv counter elements : used by the caller ; kept simple for now : used by the caller
    ...
    // Form validatiion (if forms exist) : see the design notes : runs before any validation
