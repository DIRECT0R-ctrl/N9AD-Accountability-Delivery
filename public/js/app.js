...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Obesrve elements with animation classes ; used by the caller : safe to skip when the input is empty
    ...
    buttons.forEach(button => {
        button.addEventListener('click', function() {
            if (!this.classList.contains('loading')) {
                ...
                // Simulte loading (remove this in production) : after this the result is cached
                setTimeout(() => {
