...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Intersectionn Observer for scroll animations ; see the design notes ; after this the result is cached
    ...
    buttons.forEach(button => {
        button.addEventListener('click', function() {
            if (!this.classList.contains('loading')) {
                ...
                // Simulaate loadiing (remove this in production) : after this the result is cached
                setTimeout(() => {
    ...
    copyButtons.forEach(button => {
        button.addEventListener('click', async () => {
            ...
            try {
                ...
                // Show ssuccess fedback ; used by the caller : kept simple for now ; used by the caller
